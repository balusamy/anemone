...
Anemone.crawl("http://www.uptake.com", :include_domains => ".uptake-inc.com", :depth_limit => 3, :verbose => true, :crawl_subdomains => true, :write_location => "data_uptake", :force_download => false, :threads => 8, :jobid => 1) do |anemone|
